...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <a class="btn btn-primary mb-3" data-toggle="modal" data-target="#ModalRule" href="">Tambah Rule Baru</a>
                ...
                <tbody>
                    ...
                    <?php foreach ($rule as $r) : ?>
                        <tr>
                            ...
                            <td><?= $r['role'] ?></td>
                            <td>
                                <a class="badge badge-warning" href="<?= base_url('admin/ruleakses/') . $r['id']; ?>">Akses</a>
            ...
            <form action="<?= base_url('admin/rule'); ?>" method="POST">
                <div class="modal-body">
                    <div class="form-group">
                        <input type="text" class="form-control" id="role" name="role" placeholder="Nama Rule....">
                    </div>
                </div>
