                    ...
                    <?php foreach ($pasien as $p) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="badge badge-danger" href="<?= base_url('pasien/hapuspasien_m/' . $p['id']) ?>" onclick="return confirm('Anda Yakin Menghapus Data Pasien Ini ?')">Hapus</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url('pasien/editpasien/' . 13); ?>" method="POST">
